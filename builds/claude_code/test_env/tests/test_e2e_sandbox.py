...
def _subprocess_env() -> dict:
    ...
    root = Path(__file__).resolve().parent.parent.parent.parent.parent  # abiogenesis root
    env = os.environ.copy()
    paths = [
...
from gtl.operator_model import Evaluator, Operator, Rule, F_D, F_P, F_H
...
class TestSelfHosting:
    ...
    def test_check_tags_impl_passes_on_own_code(self):
        ...
        code_path = str(Path(__file__).resolve().parent.parent.parent / "code")
        result = subprocess.run(
    ...
    def test_modules_present(self):
        ...
        genesis_dir = Path(__file__).resolve().parent.parent.parent / "code" / "genesis"
        required = {
            "__main__",
            # kernel
