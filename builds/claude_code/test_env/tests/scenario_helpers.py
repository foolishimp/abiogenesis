...
_BUILD_DIR = Path(__file__).resolve().parent.parent.parent  # builds/claude_code/
_TEST_ENV = Path(__file__).resolve().parent.parent           # builds/claude_code/test_env/
_INSTALLER = _BUILD_DIR / "code" / "gen-install.py"
