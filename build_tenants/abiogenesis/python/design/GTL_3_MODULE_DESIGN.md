...
| `M03-engine-kernel` | ABG runtime interpretation, binding, convergence, provenance, lineage, replay, correction, transport, and self-hosting | `specification/requirements/abg/`, `REQ-M-GTL2-MAPPING`, `REQ-M-GTL2-PROVENANCE` |
...
| `M06-mapping-deferred` | alternate-runtime mapping surfaces outside the canonical ABG line | `REQ-M-GTL2-CAPABILITY` |
