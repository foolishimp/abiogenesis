...
def _fp_obligation_declarations(
    ...
    *obligations: tuple[str, str, str],
    ...
    return obligation_ledger_declarations(
        ...
        obligation_source_ref=f"package://gtl_spec.packages.abiogenesis#{vector_name}",
        ...
        obligations=[
            declared_fulfillment_obligation(
                ...
                source_refs=(f"package://gtl_spec.packages.abiogenesis#{vector_name}/obligation/{obligation_id}",),
            )
...
v_design_bootdoc = GraphVector(
    ...
    declarations=_fp_obligation_declarations(
        "design→bootloader_doc",
        ("synthesize_bootloader", "synthesize_bootloader", eval_bootdoc_fp.description),
    ),
)
