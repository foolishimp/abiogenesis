...
**Status**: Retained capability contract; dedicated F08/S05 qualification reserved for 5.1
...
**Wave**: ABIogenesis 5.1 dedicated qualification
...
This family preserves the Consensus capability contract and future dedicated
qualification; it does not mandate its publication or S05 acceptance for 5.0.
Any retained published Consensus function obeys its declared contract and the
generic catalog/GTL/HoG/ABG laws. Existing implementation and evidence retain
their exact scope without an unexecuted release-complete claim.
...
**REQ-P-CONSENSUS-001**: When Consensus is published, ABIogenesis exposes exactly one canonical
