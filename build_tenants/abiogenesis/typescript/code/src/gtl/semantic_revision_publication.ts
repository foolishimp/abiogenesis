...
export function constructSemanticRevisionGraphFunction(input: { readonly graphFunctionRef: string; readonly closureContractRef: string;
  readonly childClosureContractRef?: string; readonly role: "projection" | "bridge" | "evidenceInput" | "terminal" | "nativeIntake" | "nativeRequest" | "nativeConstruction" | "nativeExecution" | "nativeEvidence"; readonly nativeEntry?: string; readonly nativeEntryRole?: "author" | "assessor"; readonly stageEntryRole?: "author" | "assessor"; readonly stage?: SemanticStageDeclaration; readonly rootOutput?: boolean }): Readonly<GraphFunction> {
