...
export {
  ...
  GTL_PROGRAM_CONFORMANCE_SCOPE_KIND_VALUES,
...
export type {
  ...
  GtlProgramDerivedConformanceInventoryCounts,
  GtlProgramEffectRequirementProjectionRow,
  GtlProgramEffectRequirementSourceKind,
  GtlProgramFeatureApplicabilityProjectionRow,
  GtlProgramHogHandlerConfigProjectionRow,
  GtlProgramHogHandlerProjectionRow,
  GtlProgramHogProgramProjectionRow,
