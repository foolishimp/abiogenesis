...
const RUNTIME_EVENT_ADMITTERS = Object.freeze({
  ...
  instruction_response_contract_admitted: applyFieldRules(
    "InstructionResponseContractAdmittedEvent",
    {
      ...
      causationEventRefs: "string_array",
      correlationId: "non_empty_string",
      responseAdmissionRef: "non_empty_string",
      manifestRef: "non_empty_string",
      manifestDigest: "non_empty_string",
      planRef: "non_empty_string",
      envelopeRef: "non_empty_string",
      resultRef: "non_empty_string",
      artifactRef: "non_empty_string",
      artifactContentDigest: "non_empty_string",
      outputContractRefs: "string_array",
      promptDigest: "non_empty_string"
    }
  ),
  instruction_causal_context_bound: applyFieldRules(
    "InstructionCausalContextBoundEvent",
    {
      ...
      bindingPolicyRefs: "string_array",
      ...
      evidenceRefs: "string_array",
      sourceProjectionRefs: "string_array",
      requiredInputRefs: "string_array",
  ...
  catalog_asset_admitted: applyFieldRules(
    "CatalogAssetAdmittedRuntimeEvent",
    {
      ...
      declarationDigest: "non_empty_string",
      libraryScope: { oneOf: ["system", "product"] },
      assetKind: { oneOf: ["overlay"] },
      namespace: "non_empty_string",
      ownerRef: "non_empty_string",
      version: "non_empty_string",
      descriptorRef: "non_empty_string",
      contributionManifestRef: "non_empty_string",
      resolvedLockRef: "non_empty_string",
      assetPath: "non_empty_string",
      schemaId: "non_empty_string",
      schemaVersion: "non_empty_string",
      schemaDigest: "non_empty_string",
      assetDigest: "non_empty_string",
      authorityRefs: "string_array",
      provenanceRefs: "string_array",
      readinessRefs: "string_array",
      proofRefs: "string_array",
  ...
  catalog_asset_rejected: applyFieldRules(
    "CatalogAssetRejectedRuntimeEvent",
    {
      ...
      refinementOfEntryRef: "nullable_string",
      overrideOfEntryRef: "nullable_string",
      rejectionReason: { oneOf: CATALOG_ASSET_REJECTION_REASON_VALUES },
      conflictingEntryRefs: "string_array",
      sourceEventRefs: "string_array",
      causationEventRefs: "string_array",
      correlationId: "non_empty_string"
