...
witness/callable field, duplicate tuples or contract keys, a GraphFunction or
Node outside that Module, or a symbolic ref differing from the selected Node.
The existing
...
digests the Valibot callable. M04 then performs the one-to-one join over each
...
16. Missing/outside-product-root public input schema asset, unresolved or wrong
    ...
    missing/duplicate/unknown-field/outside-closure Module metadata row, any
