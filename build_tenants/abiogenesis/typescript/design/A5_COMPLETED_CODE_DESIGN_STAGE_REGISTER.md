...
| One Surface semantic authority family and program application | T-280; PC-007/PC-011 | [M03_M04_ONE_SURFACE_AUTHORITY_BEHAVIOR_DESIGN.md](./M03_M04_ONE_SURFACE_AUTHORITY_BEHAVIOR_DESIGN.md) | F_H-authorized for bounded implementation; independent closure review pending | Keep AF-11, AF-12, AF-13, and AF-16 distinct, admit AF-14 without re-selection, and derive result truth from exact existing C-call event pairs while the admitted GTL program owns composition. |
