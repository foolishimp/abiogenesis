...
| Public SDK, CLI, capability preflight, invocation, result, replay, and F_H response/resume admission | T-223 public surface; T-258 accepted design | [M03_M04_PUBLIC_SDK_CLI_BEHAVIOR_DESIGN.md](./M03_M04_PUBLIC_SDK_CLI_BEHAVIOR_DESIGN.md) | T-258 `accepted`; complete 5.0 surface `blocked` | T-258 owns the typed F_H hold, response, replay, and resume-admission boundary. T-267 still owns post-resume traversal consumption; the remaining public operation families retain their own delivery owners. |
