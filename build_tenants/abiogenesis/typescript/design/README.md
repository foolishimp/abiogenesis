...
Wave 2 / `A5-F01` is current; and only the `ST-S01-ROOT/S1` v3 documentation
...
[T-287 ST-S01-ROOT/S1 v3 Artifact Carrier Design](./T287_S1_ROOT_ARTIFACT_CARRIER_DESIGN.md)
...
- [ABIogenesis 5.0 Realization Constitution](./ABI5_REALIZATION_CONSTITUTION.md)
  remains the local STDO 2.2.2 realization and review law. S1 applies its
  `FS-18` through `FS-20` foundation selection without changing Product,
  requirements, Effect, HoG, ABG, Event Calculus, replay, or Public law.
...
Only after docs acceptance, the S1 v3 design supersedes prior development
readings that:
...
Rejected docs commits `6720c0d9`, `87d369d3`, and `1e1e61af` remain immutable
evidence only. Their prose, ancestry, and implementation maps are not carried
forward by default.
