...
import { AbgEventStore } from "../../build/code/src/abg/event_store.js";
import {
...
test("R4 equal duplicates are idempotent and unequal collisions refuse", () => {
  ...
  unequalPublication.graphFunctions[0].tags = ["unequal-module-proof"];
...
test("R4 pure catalog operations admit zero registry or catalog events", () => {
