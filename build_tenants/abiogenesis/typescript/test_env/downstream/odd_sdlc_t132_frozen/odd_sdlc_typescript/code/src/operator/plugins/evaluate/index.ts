...
export {
  ...
  SDLC_DESIGN_DEPTH_CONTENT_REGISTER_PROGRESS_SURFACE_REF,
  SDLC_DESIGN_DEPTH_CONTENT_REGISTER_PROGRESS_STATES,
  ...
  type SdlcDesignDepthContentRegisterProgressSnapshot,
  type SdlcDesignDepthContentRegisterProgressState,
