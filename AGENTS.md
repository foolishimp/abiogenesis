...
- You may freely make changes within `./builds/codex`, `./specifications`, `./builds/claude_code/` and `.ai-workspace/comments/codex`. Inside these directories, changes are allowed but need to comply with Methodology.md
