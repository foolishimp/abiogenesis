...
**Status**: Current single human guide for GTL 3 / ABG 3 over the TypeScript 4.5.0-rc.8 release line
...
## ABG 4.5.0-rc.8 Runtime Boundary

The ABG 4.5.0-rc.8 TypeScript line keeps runtime law carrier and event owned.
