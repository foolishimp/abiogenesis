...
**Status**: Current single human guide for GTL 3 / ABG 3 over the TypeScript 4.3.0-rc.1 release line
...
## ABG 4.3.0-rc.1 Runtime Boundary

The ABG 4.3.0-rc.1 TypeScript line keeps runtime law carrier and event owned.
