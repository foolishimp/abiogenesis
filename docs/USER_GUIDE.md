...
**Status**: Current single human guide for GTL 3 / ABG 3 over the TypeScript 4.5.0-rc.4 release line
...
## ABG 4.5.0-rc.4 Runtime Boundary

The ABG 4.5.0-rc.4 TypeScript line keeps runtime law carrier and event owned.
