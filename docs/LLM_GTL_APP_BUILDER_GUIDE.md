...
**Status**: Current compressed technical GTL 3 / ABG 3.7.1-rc.1 guide for LLMs
...
The current source version is `3.7.1-rc.1`.
...
npm pack
cd /path/to/project
npm install /Users/jim/src/apps/abiogenesis/build_tenants/abiogenesis/typescript/abiogenesis-typescript-tenant-3.7.1-rc.1.tgz
```
...
const installOutcome = await installBootstrap(
  {
    ...
    runtimePackage: {
      ...
      dependencyRef: "file:./abiogenesis-typescript-tenant-3.7.1-rc.1.tgz",
