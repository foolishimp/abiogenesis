...
**Status**: Current compressed technical guide for GTL 3 / ABG 3 over the TypeScript 4.5.0-rc.7 release line
...
```text
@abiogenesis/typescript-tenant@4.5.0-rc.7
```
...
The current TypeScript source package version is `4.5.0-rc.7`.
...
npm pack
cd /path/to/project
npm install /Users/jim/src/apps/abiogenesis/build_tenants/abiogenesis/typescript/abiogenesis-typescript-tenant-4.5.0-rc.7.tgz
```
...
const installOutcome = await installBootstrap(
  {
    ...
    runtimePackage: {
      ...
      packageVersion: "4.5.0-rc.7",
      dependencyRef: "file:./abiogenesis-typescript-tenant-4.5.0-rc.7.tgz",
