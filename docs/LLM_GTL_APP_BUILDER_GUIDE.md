...
**Status**: Current compressed technical GTL 3 / ABG 3.4.0-rc.5 guide for LLMs
...
The current source version is `3.4.0-rc.5`.
...
npm pack
cd /path/to/project
npm install /Users/jim/src/apps/abiogenesis/build_tenants/abiogenesis/typescript/abiogenesis-typescript-tenant-3.4.0-rc.5.tgz
```
...
const installOutcome = await installBootstrap(
  {
    ...
    runtimePackage: {
      ...
      packageVersion: "3.4.0-rc.5",
      dependencyRef: "file:./abiogenesis-typescript-tenant-3.4.0-rc.5.tgz",
