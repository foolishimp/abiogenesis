...
**Status**: Current compressed technical guide for GTL 3 / ABG 3 over the TypeScript 4.5.0 release line
...
```text
@abiogenesis/typescript-tenant@4.5.0
```
...
The current TypeScript source package version is `4.5.0`.
...
npm pack
cd /path/to/project
npm install /Users/jim/src/apps/abiogenesis/build_tenants/abiogenesis/typescript/abiogenesis-typescript-tenant-4.5.0.tgz
```
...
const installOutcome = await installBootstrap(
  {
    ...
    runtimePackage: {
      ...
      dependencyRef: "file:./abiogenesis-typescript-tenant-4.5.0.tgz",
