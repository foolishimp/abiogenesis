...
1. `T-167` non-closed requirements-route replay proof with residual pressure
...
4. `T-160` recursive executive observer pressure preservation over existing
   GTL/ABG carriers, completed after the requirements-algebra and odd_glc
   lifecycle strategy made it the next substrate gap.
