...
| 6 (ACTIVE — T-216 CLOSED; 4.5.1 is the release-grade candidate; only the frozen-law proving run remains) | Foundation Release cut — 4.5.1 (was 4.5.0, blocked by T-216 (T-212 already landed rc.15; — the injected AGENTS.md/CLAUDE.md bootstrap carries the foundation boundaries as gate zero before the released installer stamps it) | authored release note claiming exactly the proven foundation; artifact-content verification (including bootstrap boundary text in the stamped install); odd_glc repin; release-grade classification |
