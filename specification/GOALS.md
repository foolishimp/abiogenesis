...
| pending T-272 design delta | Section 12 admitted four-authority composition, exact evidence fold, run-causal closure, and post-resume failure totalization, SHA-256 `d1be9081198d47f31e9b2de58451c7e73ec2ce6afee2505c5035635152f49cb0`; exact-cut review pending |
...
| current work carrier | `T-270` M5 parent; T-272 owns active S03; exact review candidate `686d18bf31eb0dd5881dea9e031eca2a47a128ea` |
| current constitutional state | accepted Product and direct-GTL design; corrected S02/S03 requirement and delivery ordering |
| implementation state | `ABI5-ROOT-001` is green; M5 `88/88`; `ABG5-S02` remains green; the S03 admitted four-authority composition, exact observation/action bases, action-evaluation admission, post-evidence refresh, run-causal closure, post-resume failure truth, and mutations are green pending exact review; the retained live F_P receipt belongs to an earlier package; implementation coverage remains 22 proven, one S03-provisional, and 17 open rows; `ABG5-S03` is current |
...
| `3` | `T-272` | **Composition/run-causal repair candidate frozen at `686d18bf`; affected design review pending; S03 open:** the separately packed developer Program publishes its action catalog and one exact four-authority construction composition. ABG binds the intent and admitted action evaluation to the exact WorkspaceBinding, observation, catalog, Product policy, actual evidence, ledger, decision, and causal runtime events. Refresh preserves the same semantic authorities; closure resolves every run-causal intent across Frames and GraphCalls; post-resume failures become ABG truth. Installed mutations cover renamed roles, policy/action/evidence/workspace substitution, cross-Frame pending intent, and post-resume failure. Remaining S03 consequence, runtime-disposition, and public-control behavior remains. |
