...
|---|---|---|---|
| `GOAL-035` | Deliver one usable installed GTL/HoG/ABG runtime that executes declared work, evaluation and consequence and supports native agents producing working, correctable software through outcomes in the workspace. | Bounded functional evidence establishes runtime capabilities; the graph/context/native-agent relation supports material workspace outcomes and their evaluation. Existing obligations for the 15 Product families, exact qualification and human release acceptance remain tracked; a version label is not a prerequisite for functional progress. Data Mapper supplies diagnostic evidence of generic framework and odd_glc behavior. | Active under STDO 2.5.1 RC1. Root selects [NATIVE-D2-01](../.ai-workspace/comments/codex/20260924_WORKSPACE_RESOURCE_LIFETIME/native-d2-01/executive-selection.md) as a design_reframe of generic native lifecycle correction: exact public source Run/prefix → owner-acquired job, eligible cause, predecessor and phase → affectedness judgment → authenticated revision request → declared whole correction suffix. Preconstruction must not invent construction evidence; postconstruction retains real native origins. Source/correction-01 are Root-accepted after review 5ad75344…; core20/dev10 package readiness is accepted. [Bootstrap preparation](../.ai-workspace/comments/codex/20260924_WORKSPACE_RESOURCE_LIFETIME/native-d2-01/bootstrap-preparation-01/return.md) closed at catalog.admit malformed_contribution after six successful setup calls (337.565s, 2.790GB peak RSS); no intake or actor launched. Native eligibility/correction remains unproved. Core19/dev9 and checkpoint17 are preserved; all five core18/dev8 Runs are closed, tenant/service bounded outcomes accepted and three stops preserved without retry. Historical Opus04 acceptance remains on core17/dev8. No new candidate qualification or paid correction launch is selected. [T-287](../.ai-workspace/tickets/active/T-287-deliver-abiogenesis-5-feature-waves.md#current-checkpoint-and-installed-continuation) retains exact evidence. Data Mapper is held; LIFE-01, fifteen-family qualification, QUAL056/F11/sole AF22 and RC1 remain open; T288/T289 stay closed. |
...
Root accepts the seven [S02 continuation17](../.ai-workspace/comments/codex/20260923_RC1_QUALIFICATION_RECIPE/s02-installed-continuation-17/return.md) case outcomes in their exact
...
[F_H source repair](../.ai-workspace/comments/codex/20260924_WORKSPACE_RESOURCE_LIFETIME/fh-hold-repair-01/return.md) (`96a89f0e…`) and
[native preparation/GLC declaration repair](../.ai-workspace/comments/codex/20260924_WORKSPACE_RESOURCE_LIFETIME/native-preparation-repair-01/return.md)
