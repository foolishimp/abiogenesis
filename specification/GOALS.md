...
| `3` | `T-272` | **First vertical path green; S03 open:** a separately packed developer Program owns supervised `start`, orders distinct `synthesizeModel -> evalGap -> evaluateNext -> F_H -> evaluateAction` loci, survives fresh-context read/respond/continue, and closes the same Run from replay. Explicit construction-intent and evidence/evaluator-result admission, post-evidence refresh, and the remaining consequence, runtime-disposition, and public-control rows remain. |
