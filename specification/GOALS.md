...
| accepted T-272 design delta | M05 Sections 12 through 12.7 admit the four-authority composition, exact evidence fold, run-causal closure, post-resume failure totalization, single-use Product-bound gap re-entry, side-effect-free resolved Run projection, and exact typed `reprice_required` stop; complete design SHA-256 `ad54dc33fb127506a024843af258771b79e99e161577e0e887e33075675fd441`; latest bounded proxy decision `20260724T203655Z_DECISION_proxy_accept_t272_reprice_required_stop.md` |
...
| current work carrier | `T-270` M5 parent; T-272 owns active S03; latest accepted implementation is typed reprice-required stop `f611a72de605520b1637d51e5bdc956e9868f07e`; external ticket traversal proof is `f79e1358d8383a99067375751e3009e55b1bf1b2`; proof reconciliation is `4691b132bebbad118e528efe49bc2cd6cd85efca` |
| current constitutional state | accepted Product and direct-GTL design; corrected S02/S03 requirement and delivery ordering |
| implementation state | `ABI5-ROOT-001` is green; M5 `97/97`; `ABG5-S02` remains green; the S03 four-authority composition, exact observation/action bases, action-evaluation admission, post-evidence refresh, run-causal closure, post-resume failure truth, Product-defined no-action, ABG `gap_stop`, exact single-use fresh-context re-entry, fresh-context status/result/replay/lawful-action projection, typed Product-derived `reprice_required` stop, and external product-declared ticket traversal are accepted; the retained live F_P receipt belongs to an earlier package; conservation remains a derived projection with 54 pass and 8 explicit TODO (32 proven rows, one provisional row, seven open rows); `ABG5-S03` is current |
...
| `3` | `T-272` | **Typed `reprice_required` stop accepted at `f611a72d`; external ticket traversal proven at `f79e1358`; installed control proof reconciled at `4691b132`; S03 open:** the separately packed developer Product publishes its action catalog, four-authority construction composition, and an independently owned ticket Program and GraphFunction. ABG preserves Product-derived `gap_stop` and `reprice_required`, exact single-use re-entry, durable projections, ticket result truth, F_H control, bounded stop/convergence, and yield truth through the same generic path. Product-selected graph-span re-entry and the remaining S03 consequence/runtime/public-control behavior remain. |
