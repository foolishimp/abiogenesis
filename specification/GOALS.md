...
- S06 is design-gated at
  ...
  `c48e9df90bf125ac08d2c4b9183a7622d966859a`, design digest
  `5da0de37d0eba0143f3562eaa7dfcb5caa323ab17f075c4b0fdc2aa88349adba`,
  retains that exact subset and adds the full REQ-P-PUBLIC-CONTRACTS-005..011
  closure residual over groups, rows, locators, rosters, operations,
  capabilities, and the accepted capability graph. It is frozen for one
  independent delta review. Returned designs `9fb14e68` and `8eb7564c` are
  evidence only. Realization is held.
...
- T-270 remains the M5 parent owner. It owns exact owner-published completion
  ...
  subset; full closure also requires the nine groups and locators, 18 operation
  identities and projections, 16 capability identities, and the accepted
  capability graph with its owning-contract and dependency relations. S06
  emits both typed residuals and does not author absent publication truth.
...
`844df3fcbccaef97e27cc27264ad2622cea6e889`, tree
`c48e9df90bf125ac08d2c4b9183a7622d966859a`, is frozen for review over
returned predecessor `356aa6a24fbfaac32c9ce2bb4fbc8b78f59bcd92` and accepted
...
| `3` | `T-281`, under `T-270` | Close `ABG5-S06` | Native SDK, CLI, and bounded Codex projection agree; the independent flavored Product authors, publishes, applies, and invokes through installed package exports and public contracts only; no copied runtime or private path participates. | Native design `4f80f84a` accepted; full-closure replacement `844df3fc` frozen for review; realization held |
