...
| `M4` | Establish installed root | Exact `ABI5-ROOT-001` runs green through packed bytes, clean install, direct HoG traversal, ABG replay twice, and typed CLI result. | Active under T-286; clean successor boundary complete at `9d442b4c`; `R1` at `95eef983`; `R2` at `6bc4fb11`; `R3` at `e7908cde`; `R4` at `abcdca70`; `R5` at `3d5ee716`; `R6` at `2cf92015`; `R7` at `9a5b1fbf`; `R8` at `68aa3b10`; `R9` at `79f0e00b`; `R10` at `39a0b6bc`; rival-path assurance at `16bca623`; exact-candidate review pending |
