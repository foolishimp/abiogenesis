...
| `M4` | Establish installed root | Exact `ABI5-ROOT-001` runs green through packed bytes, clean install, direct HoG traversal, ABG replay twice, and typed CLI result. | Active under T-286; clean successor boundary complete at `9d442b4c`; `R1` at `95eef983`; `R2` at `6bc4fb11`; `R3` at `e7908cde`; frontier `R4` |
