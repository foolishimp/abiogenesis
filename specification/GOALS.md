...
| accepted T-272 design delta | Section 12 admitted four-authority composition, exact evidence fold, run-causal closure, and post-resume failure totalization, SHA-256 `d1be9081198d47f31e9b2de58451c7e73ec2ce6afee2505c5035635152f49cb0`; accepted by direct F_H on 2026-07-25 |
...
| current work carrier | `T-270` M5 parent; T-272 owns active S03; durable gap/re-entry exact review candidate `91f3640fcbb12788c34fcc17e54480390ca4d3b4` |
| current constitutional state | accepted Product and direct-GTL design; corrected S02/S03 requirement and delivery ordering |
| implementation state | `ABI5-ROOT-001` is green; M5 `89/89`; `ABG5-S02` remains green; the S03 four-authority composition, exact observation/action bases, action-evaluation admission, post-evidence refresh, run-causal closure, and post-resume failure truth are accepted; candidate `91f3640f` adds Product-defined no-action, ABG `gap_stop`, replay-derived public read, exact fresh-context re-entry, stale/substituted authority refusal, and convergence; Section 12.5 review is pending; the retained live F_P receipt belongs to an earlier package; implementation coverage remains 22 proven, one S03-provisional, and 17 open rows; `ABG5-S03` is current |
...
| `3` | `T-272` | **Composition/run-causal repair accepted at `686d18bf`; gap re-entry candidate `91f3640f` pending review; S03 open:** the separately packed developer Program publishes its action catalog and exact four-authority construction composition. ABG binds intent and action evaluation to the exact WorkspaceBinding, observation, catalog, Product policy, actual evidence, ledger, decision, and causal runtime events. Candidate `91f3640f` additionally admits Product-defined no-action as `gap_stop`, projects it without appending truth, and permits one exact fresh-context public re-entry before ordinary F_H convergence. Remaining S03 consequence, runtime-disposition, and public-control behavior remains. |
