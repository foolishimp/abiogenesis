...
**Date**: 2026-04-29
**Derives from**: [SPEC_METHOD.md](stdo://releases/v2.5.0-rc.4/standards/SPEC_METHOD.md), [ODD_METHOD.md](stdo://releases/v2.5.0-rc.4/standards/ODD_METHOD.md), [INTENT.md](../../INTENT.md) INT-001, [PRODUCT.md](../../PRODUCT.md), [REQ-R-ABG3-EVENTS.md](REQ-R-ABG3-EVENTS.md), [REQ-R-ABG3-PROJECTION.md](REQ-R-ABG3-PROJECTION.md), [REQ-R-ABG3-CONVERGENCE.md](REQ-R-ABG3-CONVERGENCE.md), [REQ-R-ABG3-CORRECTION.md](REQ-R-ABG3-CORRECTION.md)
...
**REQ-R-ABG3-ASSURANCE-035**: Composition-governed evaluation findings may carry an admitted evaluation scope ref for edge, segment, dimension-cell, fold, or relation scope inside the current graph-vector boundary. Assurance projection shall preserve that scope on derived rows without making the scoped finding close, emit runtime truth, select traversal, or write ledgers.

**REQ-R-ABG3-ASSURANCE-036**: Assurance over scoped evaluation shall fold the full current scoped row set. One fulfilled scoped row shall not close the whole boundary while another required current scoped row is partial, missing, stale, orphan-bound, contradictory, blocked, or non-lawfully deferred. One failed scoped row shall not invalidate sibling scoped rows unless admitted authority, input, correction, or lineage truth requires that invalidation.
