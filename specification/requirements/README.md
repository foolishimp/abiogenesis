...
- Treat `build_tenants/abiogenesis/python/` as the current canonical released realization and `build_tenants/abiogenesis/codex/` as a paused partial alternate realization unless explicitly repriced.
