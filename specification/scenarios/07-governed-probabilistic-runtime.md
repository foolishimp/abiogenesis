...
**Validates**: REQ-R-ABG3-INTERPRET, REQ-R-ABG3-CONVERGENCE, REQ-R-ABG3-POLICY, REQ-R-ABG3-SELECTION-APPLICATION, REQ-R-ABG3-LEAFTASK, REQ-R-ABG3-TRANSPORT
...
`F_P` transport when deterministic handling remains open.
...
3. deterministic invalid/erroring paths fail closed rather than silently
   escalating to `F_P`
4. bounded subordinate subwork stays schema-driven and replay-visible
5. all post-dispatch fact truth is engine-owned
