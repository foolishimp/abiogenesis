...
| `REQ-L-GTL3-HOF-001` | `09-research-product-lab-scenario-catalog.md` section 4 | proves a generic `A -> B` transform over distinct explicit input and result vectors, with stable order and per-item evidence |
