...
- a project's `INTENT.md` and `requirements/` define the domain constitution
...
5. Check the reconstruction boundary: can the current requirements support the intended design, and can the current design support the intended implementation?
6. Only then implement **Code**.
7. Use **Events, Projection, and Delta** to verify whether reality still satisfies the requirements.
