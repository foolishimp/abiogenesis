...
| 3c2 | Body + census (T-252, branch 754341a) | ✅ verified clean-room 1,569/1,569; census ↔ routing reconciled; F_H closure pending | ~2h actual |
| 4 | Admission + conformance (T-263→T-264) | 🔍 designs complete; F_H accepts pending + ONE ruling: capability-compat routing (rec: T-255, narrow REQ-M-GTL3-CAPABILITY admission) | ~1.5–3h est |
