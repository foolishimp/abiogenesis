...
|---|---|---|---|
| `GOAL-035` | Deliver one usable installed GTL/HoG/ABG runtime that executes declared work, evaluation and consequence and supports native agents producing working, correctable software through outcomes in the workspace. | Bounded functional evidence establishes runtime capabilities; the graph/context/native-agent relation supports material workspace outcomes and their evaluation. Existing obligations for the 15 Product families, exact qualification and human release acceptance remain tracked; a version label is not a prerequisite for functional progress. Data Mapper supplies diagnostic evidence of generic framework and odd_glc behavior. | Active under STDO 2.5.1 RC1. Opus04 complete basic-cli full native outcome remains Executive-accepted on its historical core17/dev8 execution. [T-287](../.ai-workspace/tickets/active/T-287-deliver-abiogenesis-5-feature-waves.md#current-checkpoint-and-installed-continuation) owns accepted core18 lookup/cold Result proof and new immutable core18/dev8 preparation for the remaining five cases. Prior core17 setups remain preserved and unselected. Core18 successor preparation and parallel execution remain selected under unchanged controls. All five reached core18/dev8 installation but stopped before binding on a caller hash-domain assertion; original oracles are unchanged, and the selected caller correction continues the existing setup tail from genuine closes. No Run or actor started. No further basic-cli execution is needed. Remaining case outcomes, LIFE-01 costs, Data Mapper, fifteen-family completion, qualification and RC1 remain open. |
