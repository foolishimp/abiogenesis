...
repo=Path(sys.argv[1]).resolve();root=repo/'.ai-workspace/comments/codex/20260923_WIP_CHECKPOINT/successor-16';previous=root.parent/'successor-01';out=root/'transport-01'
...
restoration=Path('/private/tmp')/('20260924-checkpoint-successor16-'+repo.name+'-'+str(os.getpid()));restoration.mkdir(exist_ok=False)
